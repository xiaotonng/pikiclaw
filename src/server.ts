/**
 * server.ts — Hono-based dashboard server for pikiclaw configuration
 * and monitoring.
 *
 * Replaces the raw http.createServer approach in dashboard.ts with
 * a Hono app that mounts route modules and serves static dashboard files.
 */
